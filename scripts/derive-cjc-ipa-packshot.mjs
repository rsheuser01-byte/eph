/**
 * Derive CJC-IPA packshot from SEMAX master by replacing product name.
 * Similar to derive-kpv-packshot.mjs but for CJC-1295 + Ipamorelin blend.
 */
...
const outPath = path.join(productsDir, "cjc-ipa-10mg.png");
